        ...
        <Col md={12}>
            ...
            <ListGroup>
                <ListGroupItem className="border-0"><FaCircle size={5} style={{marginBottom:'3px',marginRight:'7px'}}/>Επιστημονικός Συνεργάτης – Χειρουργός ΩΡΛ σε Ιδιωτικά Νοσοκομεία &amp; Κλινικές για επεμβάσεις Ενηλίκων και Παίδων:
                    <ListGroup>
                        <ListGroupItem className="border-0 align-self-center font-weight-bold">Νοσοκομείο ΥΓΕΙΑ και Νοσοκομείο ΜΗΤΕΡΑ</ListGroupItem>
                        <ListGroupItem className="border-0 align-self-center font-weight-bold">METROPOLITAN Hospital και METROPOLITAN General</ListGroupItem>
                        <ListGroupItem className="border-0 align-self-center font-weight-bold">ΙΑΣΩ ΠΑΙΔΩΝ - ΕΡΡΙΚΟΣ ΝΤΥΝΑΝ</ListGroupItem>
                        <ListGroupItem className="border-0 align-self-center font-weight-bold">ΕΥΡΩΚΛΙΝΙΚΗ ΑΘΗΝΩΝ και ΠΑΙΔΩΝ</ListGroupItem>
                        <ListGroupItem className="border-0 align-self-center font-weight-bold">Athens ORL clinic - ΑΘΗΝΑΙΚΗ Mediclinic</ListGroupItem>
                    </ListGroup>
                </ListGroupItem>
                <ListGroupItem className="border-0"><FaCircle size={5} style={{marginBottom:'3px',marginRight:'7px'}}/>Συνεργασία με Ιδιωτικές Ασφαλιστικές εταιρείες για Εξέταση στο ιατρείο, Νοσηλεία και Χειρουργικές Επεμβάσεις:
                    <ListGroup>
                        ...
                        <ListGroupItem className="border-0"><FaMinus size={5} style={{marginBottom:'3px',marginRight:'7px'}}/>Συμβεβλημένος Ιατρός Γραμμής Υγείας για Ατομικά και Ομαδικά ασφαλιστικά
συμβόλαια των εταιρειών:</ListGroupItem>
                        <ListGroupItem className="border-0">
                            <ListGroup>
                                ...
                                <ListGroupItem className="border-0 align-self-center font-weight-bold">GROUPAMA ΦΟΙΝΙΞ – EUROLIFE - INTERASCO - NN Hellas ΜΙΝΕΤΤΑ</ListGroupItem>
                ...
                <ListGroupItem className="border-0"><FaCircle size={5} style={{marginBottom:'3px',marginRight:'7px'}}/>Συμβεβλημένος Ιατρός ΕΔΟΕΑΠ</ListGroupItem>
