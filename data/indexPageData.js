import service1 from '../src/images/services/apnea.png';
import service2 from '../src/images/services/rhinoplastic.png';
import service3 from '../src/images/services/autosurgery.png';
import service4 from '../src/images/services/fess.png';
import service5 from '../src/images/services/phoniatric.png';
import service6 from '../src/images/services/swallowing.png';
...
const services = [
    {   servicename: 'Ρινοπλαστική', 
        ...
        serviceurl: 'surgery/rhinoplastic'
    },
    {   servicename: 'Χειρουργικές επεμβάσεις Φάρυγγος και Ροχαλητού/Άπνοιας', 
        ...
        imagesrc: service2,
        imagealt: 'apnea-img',
        serviceurl: 'surgery/snoring-and-sleep-apnoea-surgery'
    },
    {   servicename: 'Χειρουργικές επεμβάσεις Φάρυγγος και Ροχαλητού/Άπνοιας', 
        description: 'Αμυγδαλεκτομή-Ενδοσκοπική Αδενοειδεκτομή. LASER ΦαρυγγοΥπερωιοπλαστική. Επεμβάσεις Βάσης Γλώσσης και Υπερώας με Ραδιοσυχνότητες. Expansion Sphincter Pharyngoplasty.', 
        imagesrc: service3,
