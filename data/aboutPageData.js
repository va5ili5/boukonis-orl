...
const education = {
    ...
    edudetails: [
        ...
        'Ωτοχειρουργική, Χειρουργική Ρογχοπαθειών και Υπνικής Άπνοιας, Φωνομικροχειρουργική και Χειρουργική Κεφαλής & Τραχήλου.' +
        'Queen’s Hospital London, BHR University Hospitals NHS Trust, London United Kingdom' +
        'Eastbourne District General Hospital, East Sussex, United Kingdom 2013-2017'
    ]
}
